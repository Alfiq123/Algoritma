# Buatlah program untuk menghitung jumlah pembayaran gaji dengan input nama, status
# (K/TK), golongan pegawai, jumlah anak.
# Gaji pokok golongan A=3 jt, gol B=3,5 jt, gol. C=4 jt.
# Tunjangan istri diberikan sebesar 10% dari gaji pokok, dan tunjangan anak diberikan
# sebesar 5% dari gaji pokok sampai anak ke-2. Tunjangan beras diberikan kepada anggota
# keluarga yang menjadi tanggungan, dalam bentuk rupiah.
...
# Tunjangan Anak = Gaji Pokok * 5% * Jumlah Anak
# Tunjangan Beras = (Istri + Jumlah Anak) * Rp. 75.000
# Tunjangan Beras Tanpa Istri = Jumlah Anak * Ro. 75.000
...
# Tunjangan Beras Dalam Bentuk Rupiah ???
# Harga Beras 5kg = Rp. 75.000 (Mungkin...)
tunjangan_beras = (1 + jumlah_anak) * 75000 if status == "K" else jumlah_anak * 75000

# Menjumlahkan Gaji Karyawan
